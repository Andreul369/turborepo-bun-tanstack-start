...
const HeroSection = ({ blogData }: { blogData: BlogPost[] }) => {
  ...
  return (
    <section id="home" className="-mt-16 bg-muted pt-32 pb-12 sm:pb-16 lg:pb-24">
      <div className="mx-auto flex h-full max-w-7xl flex-col gap-16 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex max-w-4xl flex-col items-center gap-4 self-center text-center">
          ...
          <p className="mx-auto max-w-2xl text-muted-foreground text-xl">
            Learn how to design, develop, launch, and grow digital products through practical
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
          {featuredPosts.map((item, index) => (
            ...
            >
              <CardContent
                className="grid grid-cols-1 px-0 xl:grid-cols-2"
                onClick={() => handleCardClick(item)}
              >
                <div className="p-6">
                ...
                <div className="flex flex-col justify-center gap-3 p-6">
                  <div className="flex items-center gap-1.5 py-1">
                    ...
                    <Badge
                      className="cursor-pointer border-0 bg-primary/10 text-primary text-sm"
                      onClick={(e) => {
                        e.stopPropagation();
                  ...
                  <div className="flex w-full items-center justify-between gap-1 py-1">
                    <span className="cursor-pointer font-medium text-sm">{item.author}</span>
                    <Link
                      to="/"
